...
const AnimatedButton: FC<AnimatedButtonProps> = ({ style = {}, text, onPress, initDelay = 0, initAnimate = true }) => {
    ...
    return (
        <TouchableWithoutFeedback onPressIn={onPressInAnim} onPressOut={onPressOutAnim} onPress={onPress}>
            <View style={[styles.buttonContainer, style]}>
                <AnimatedLinearGradient style={[styles.button, { height: heightInterpolate, width: widthInterpolate }]} colors={gradients.button}>
